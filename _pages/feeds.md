...
{% assign post_types = site.posts | map: "type_of_writing" | compact | uniq | sort %}
{% for post_type in post_types %}
  - [{{ post_type | capitalize }}](/feed/{{ post_type }}.xml){:data-fathom="RSS subscription"}
{% endfor %}
...
- [{{ category | replace: "-", " " | capitalize }}](/feed/categories/{{ category }}.xml){:data-fathom="RSS subscription" class="capitalize"}
{% endfor %}
